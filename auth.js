...
passport.use(new BasicStrategy(
    //this is the callback function that will recieve the userid and password
    //after extracting them from the request header
    function (userid, password, done){
        //we need to create User.findOne function
        //this function recieve a call back to pass either error or user object 
        User.findOne({ email: userid, password: password}, function(err, user){
            ...
            //we will use done() method which is provided by password to save final decision 
